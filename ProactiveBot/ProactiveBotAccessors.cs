...
namespace ProactiveBot
{
    ...
    /// </summary>
    public class ProactiveBotAccessors
    {
        /// <summary>
        ...
        public ProactiveBotAccessors(ConversationState conversationState)
        {
        ...
        public static string CounterStateName { get; } = $"{nameof(ProactiveBotAccessors)}.CounterState";
